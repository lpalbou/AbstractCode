// SCALE CONTROL — the control-playable game rendered at 240x180.
//
// The game is UNCHANGED: same modules, same logic, same virtual-clock
// integration, same everything. The canvas is 0.5x the linear size and a single
...
// Render the 480x360 logical picture into a 240x180 canvas.
